...
<style>
  ...
  .dv-tagline {{ font-size: clamp(1.05rem, 2.5vw, 1.35rem); color: var(--ink-dim); max-width: 560px; margin: 24px auto 0; font-weight: 300; }}
  ...
  .dv-sec-sub {{ text-align: center; color: var(--ink-dim); max-width: 520px; margin: 0 auto 48px; font-size: 1rem; font-weight: 300; }}
  ...
  .dv-card p {{ color: var(--ink-dim); font-size: .93rem; font-weight: 300; }}
  ...
  .dv-note {{ text-align: center; font-size: .74rem; font-weight: 300; color: var(--ink-dim); margin-top: 18px; }}
  ...
  .dv-footer p {{ font-size: .74rem; font-weight: 300; color: var(--ink-dim); line-height: 1.9; }}
